...
function searchInit () {
  searchForm = select('.javascripts-search-form')[ 0 ];
  searchButton = select('.javascripts-search-button')[ 0 ];
  searchButtonContainer = select('.javascripts-search-button-container')[ 0 ];
